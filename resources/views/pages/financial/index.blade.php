...
<div class="space-y-5">
    ...
    {{-- Summary cards --}}
    <div>
        <button onclick="toggleSection('sec-cashflow-kpi', this)" class="w-full flex items-center justify-between px-4 py-3 bg-brand-surface border border-brand-border rounded-xl cursor-pointer hover:bg-brand-bg transition-colors">
            <span class="text-[13px] font-semibold text-brand-black">Cash Flow Overview</span>
            <svg class="w-4 h-4 text-brand-muted transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
        </button>
        <div id="sec-cashflow-kpi" class="collapsible-body">
            <div class="pt-3">
    ...
    <div>
        <button onclick="toggleSection('sec-cashflow-detail', this)" class="w-full flex items-center justify-between px-4 py-3 bg-brand-surface border border-brand-border rounded-xl cursor-pointer hover:bg-brand-bg transition-colors">
            <span class="text-[13px] font-semibold text-brand-black">Cash Flow & Bank Accounts</span>
            <svg class="w-4 h-4 text-brand-muted transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
        </button>
        <div id="sec-cashflow-detail" class="collapsible-body">
            <div class="pt-3">
    ...
    <div>
        <button onclick="toggleSection('sec-ar', this)" class="w-full flex items-center justify-between px-4 py-3 bg-brand-surface border border-brand-border rounded-xl cursor-pointer hover:bg-brand-bg transition-colors">
            <span class="text-[13px] font-semibold text-brand-black">Account Receivable</span>
            <svg class="w-4 h-4 text-brand-muted transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
        </button>
        <div id="sec-ar" class="collapsible-body">
            <div class="pt-3">
    ...
    <div class="space-y-4">
        ...
        <div class="card">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <div class="flex items-center gap-3 p-3 border border-brand-border rounded-lg">
                    <div class="flex-shrink-0 w-10 h-10 bg-brand-bg rounded-lg flex items-center justify-center">
                    ...
                    <div>
                        ...
                        <p class="text-[22px] font-semibold text-brand-black tracking-tight leading-tight">55,237</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3 p-3 border border-brand-border rounded-lg">
                    ...
                    <div>
                        ...
                        <p class="text-[22px] font-semibold text-brand-black tracking-tight leading-tight">50,139</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3 p-3 border border-brand-border rounded-lg">
                    <div class="flex-shrink-0 w-10 h-10 bg-brand-bg rounded-lg flex items-center justify-center">
                        <div class="relative">
                            ...
                            <span class="absolute -bottom-1 -right-2 text-[7px] font-bold text-brand-black">30</span>
                        </div>
                    </div>
                    <div>
                        <p class="text-[11px] text-brand-muted leading-tight">Overdue invoices 30+ days</p>
                        <p class="text-[22px] font-semibold text-brand-black tracking-tight leading-tight">28,143</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3 p-3 border border-brand-border rounded-lg">
                    <div class="flex-shrink-0 w-10 h-10 bg-brand-bg rounded-lg flex items-center justify-center">
                        <div class="relative">
                            ...
                            <span class="absolute -bottom-1 -right-2 text-[7px] font-bold text-brand-black">90</span>
                        </div>
                    </div>
                    <div>
                        <p class="text-[11px] text-brand-muted leading-tight">Overdue invoices 90+ days</p>
                        <p class="text-[22px] font-semibold text-brand-black tracking-tight leading-tight">3,510</p>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="mb-5">
                <span class="text-[13px] font-bold text-brand-black">Unpaid invoices amount by customer (Top 10)</span>
                        ...
                        <table class="w-full text-[11px]">
                            <thead>
                                <tr class="bg-brand-black text-white">
                                    ...
                                    <th class="text-right px-3 py-2.5 font-medium whitespace-nowrap">91 and over</th>
                                    <th class="text-right px-3 py-2.5 font-medium whitespace-nowrap">Amount due</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-brand-border">
                                @foreach([
                                    ['name' => 'TechAdvantage Software', 'current' => 0,    '1_30' => 8314,  '31_60' => 0,    '61_90' => 0,    '91' => 0,    'total' => 8314],
                                    ['name' => 'Coastal Shipping',       'current' => 2450, '1_30' => 4234,  '31_60' => 5350, '61_90' => 0,    '91' => 2500, 'total' => 14534],
                                    ['name' => 'City Construction',      'current' => 0,    '1_30' => 0,     '31_60' => 5600, '61_90' => 3247, '91' => 1500, 'total' => 10347],
                                    ['name' => 'Urban Apparel',          'current' => 1200, '1_30' => 3800,  '31_60' => 2100, '61_90' => 0,    '91' => 0,    'total' => 7100],
                                    ['name' => 'Global Exports Co.',     'current' => 0,    '1_30' => 0,     '31_60' => 0,    '61_90' => 3594, '91' => 1745, 'total' => 5339],
                                    ['name' => 'Green Gardens',          'current' => 1800, '1_30' => 1667,  '31_60' => 0,    '61_90' => 0,    '91' => 0,    'total' => 3467],
                                    ['name' => 'Innovative Tech',        'current' => 0,    '1_30' => 2012,  '31_60' => 1400, '61_90' => 0,    '91' => 0,    'total' => 3412],
                                    ['name' => 'Solar Solutions',        'current' => 1087, '1_30' => 1500,  '31_60' => 0,    '61_90' => 0,    '91' => 0,    'total' => 2587],
                                ] as $row)
                                    <tr class="{{ $loop->even ? 'bg-brand-bg/40' : 'bg-white' }} hover:bg-brand-bg transition-colors">
                                        <td class="px-3 py-2 text-brand-black font-medium max-w-[130px] truncate">{{ $row['name'] }}</td>
                                        <td class="px-3 py-2 text-right font-mono text-brand-subtle">{{ $row['current'] ? number_format($row['current']) : '0' }}</td>
                                        <td class="px-3 py-2 text-right font-mono text-brand-subtle">{{ $row['1_30'] ? number_format($row['1_30']) : '0' }}</td>
                                        <td class="px-3 py-2 text-right font-mono text-brand-subtle">{{ $row['31_60'] ? number_format($row['31_60']) : '0' }}</td>
                                        <td class="px-3 py-2 text-right font-mono text-brand-subtle">{{ $row['61_90'] ? number_format($row['61_90']) : '0' }}</td>
                                        <td class="px-3 py-2 text-right font-mono text-brand-subtle">{{ $row['91'] ? number_format($row['91']) : '0' }}</td>
                                        <td class="px-3 py-2 text-right font-mono font-semibold text-brand-black">{{ number_format($row['total']) }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                ...
                <div class="card p-0 overflow-hidden">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-[11px]">
                            ...
                            <tbody class="divide-y divide-brand-border">
                                @foreach([
                                    ['customer' => 'Global Exports Co.',     'number' => 1049, 'date' => 'Jul 30, 2024', 'due' => 'Aug 29, 2024', 'amount' => 3594],
                                    ['customer' => 'TechAdvantage Software', 'number' => 1055, 'date' => 'Aug 1, 2024',  'due' => 'Aug 31, 2024', 'amount' => 8314],
                                    ['customer' => 'Coastal Shipping',       'number' => 1023, 'date' => 'Jun 15, 2024', 'due' => 'Jul 15, 2024', 'amount' => 5350],
                                    ['customer' => 'City Construction',      'number' => 1031, 'date' => 'May 28, 2024', 'due' => 'Jun 27, 2024', 'amount' => 5600],
                                    ['customer' => 'Urban Apparel',          'number' => 1048, 'date' => 'Jul 25, 2024', 'due' => 'Aug 24, 2024', 'amount' => 3800],
                                    ['customer' => 'Innovative Tech',        'number' => 1037, 'date' => 'Jul 5, 2024',  'due' => 'Aug 4, 2024',  'amount' => 2012],
                                    ['customer' => 'Green Gardens',          'number' => 1042, 'date' => 'Jul 15, 2024', 'due' => 'Aug 14, 2024', 'amount' => 1667],
                                    ['customer' => 'Solar Solutions',        'number' => 1051, 'date' => 'Aug 5, 2024',  'due' => 'Sep 4, 2024',  'amount' => 1500],
                                ] as $inv)
                                    <tr class="{{ $loop->even ? 'bg-brand-bg/40' : 'bg-white' }} hover:bg-brand-bg transition-colors">
                                        <td class="px-3 py-2 text-brand-black font-medium">{{ $inv['customer'] }}</td>
                                        <td class="px-3 py-2 text-right font-mono text-brand-subtle">{{ $inv['number'] }}</td>
                                        <td class="px-3 py-2 text-right text-brand-subtle">{{ $inv['date'] }}</td>
                                        <td class="px-3 py-2 text-right text-brand-subtle">{{ $inv['due'] }}</td>
                                        <td class="px-3 py-2 text-right font-mono font-semibold text-brand-black">{{ number_format($inv['amount']) }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
    ...
    <div>
        <button onclick="toggleSection('sec-ap', this)" class="w-full flex items-center justify-between px-4 py-3 bg-brand-surface border border-brand-border rounded-xl cursor-pointer hover:bg-brand-bg transition-colors">
            <span class="text-[13px] font-semibold text-brand-black">Account Payable</span>
            <svg class="w-4 h-4 text-brand-muted transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
        </button>
        <div id="sec-ap" class="collapsible-body">
            <div class="pt-3">
    ...
    <div class="space-y-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <div class="flex items-center gap-3 p-3 border border-brand-border rounded-lg">
                    ...
                    <div>
                        ...
                        <p class="text-[22px] font-semibold text-brand-black tracking-tight leading-tight">19,217</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3 p-3 border border-brand-border rounded-lg">
                    ...
                    <div>
                        <p class="text-[11px] text-brand-muted leading-tight">Overdue amount</p>
                        <p class="text-[22px] font-semibold text-brand-black tracking-tight leading-tight">14,616</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3 p-3 border border-brand-border rounded-lg">
                    ...
                    <div>
                        ...
                        <p class="text-[22px] font-semibold text-brand-black tracking-tight leading-tight">4,817</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3 p-3 border border-brand-border rounded-lg">
                    ...
                    <div>
                        ...
                        <p class="text-[22px] font-semibold text-brand-black tracking-tight leading-tight">574</p>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="mb-5">
                <span class="text-[13px] font-bold text-brand-black">Unpaid bills amount by vendor (Top 10)</span>
                <span class="text-[11px] text-brand-muted ml-2">in home currency</span>
            </div>
            <div class="grid grid-cols-1 xl:grid-cols-5 gap-6 items-center">
                <div class="xl:col-span-3 h-64">
                ...
                <div class="card p-0 overflow-hidden">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-[11px]">
                            ...
                            <tbody class="divide-y divide-brand-border">
                                @foreach([
                                    ['name' => 'TechAdvantage Software', 'current' => 487,  '1_30' => 3129, '31_60' => 0,    '61_90' => 0,   '91' => 0,   'total' => 3616],
                                    ['name' => 'Innovative Tech',        'current' => 0,    '1_30' => 0,    '31_60' => 3728, '61_90' => 0,   '91' => 0,   'total' => 3728],
                                    ['name' => 'Coastal Shipping',       'current' => 1200, '1_30' => 2273, '31_60' => 0,    '61_90' => 0,   '91' => 0,   'total' => 3473],
                                    ['name' => 'Green Gardens',          'current' => 0,    '1_30' => 1500, '31_60' => 1444, '61_90' => 0,   '91' => 0,   'total' => 2944],
                                    ['name' => 'City Construction',      'current' => 487,  '1_30' => 531,  '31_60' => 1238, '61_90' => 0,   '91' => 0,   'total' => 2256],
                                    ['name' => 'Urban Apparel',          'current' => 985,  '1_30' => 1000, '31_60' => 0,    '61_90' => 0,   '91' => 0,   'total' => 1985],
                                    ['name' => 'Global Exports Co.',     'current' => 0,    '1_30' => 0,    '31_60' => 641,  '61_90' => 0,   '91' => 0,   'total' => 641],
                                    ['name' => 'Solar Solutions',        'current' => 0,    '1_30' => 0,    '31_60' => 0,    '61_90' => 574, '91' => 0,   'total' => 574],
                                ] as $row)
                                    <tr class="{{ $loop->even ? 'bg-brand-bg/40' : 'bg-white' }} hover:bg-brand-bg transition-colors">
                                        <td class="px-3 py-2 text-brand-black font-medium max-w-[130px] truncate">{{ $row['name'] }}</td>
                                        <td class="px-3 py-2 text-right font-mono text-brand-subtle">{{ $row['current'] ? number_format($row['current']) : '0' }}</td>
                        ...
                        <table class="w-full text-[11px]">
                            <thead>
                                <tr class="bg-brand-black text-white">
                                    ...
                                    <th class="text-right px-3 py-2.5 font-medium">Due date</th>
                                    <th class="text-right px-3 py-2.5 font-medium whitespace-nowrap">Past due (days)</th>
                                    <th class="text-right px-3 py-2.5 font-medium whitespace-nowrap">Amount Due</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-brand-border">
                                @foreach([
                                    ...
                                    <tr class="{{ $loop->even ? 'bg-brand-bg/40' : 'bg-white' }} hover:bg-brand-bg transition-colors">
                                        <td class="px-3 py-2 text-brand-black font-medium">{{ $bill['vendor'] }}</td>
                                        <td class="px-3 py-2 text-right font-mono text-brand-subtle">{{ $bill['bill'] }}</td>
                                        <td class="px-3 py-2 text-right text-brand-subtle">{{ $bill['date'] }}</td>
                                        <td class="px-3 py-2 text-right text-brand-subtle">{{ $bill['due'] }}</td>
                                        <td class="px-3 py-2 text-right font-mono {{ $bill['past'] > 60 ? 'text-status-red font-semibold' : ($bill['past'] > 30 ? 'text-status-amber' : 'text-brand-subtle') }}">{{ $bill['past'] }}</td>
                                        <td class="px-3 py-2 text-right font-mono font-semibold text-brand-black">{{ number_format($bill['amount']) }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
...
document.addEventListener('DOMContentLoaded', () => {
    const arCustomers = ['Coastal Shipping', 'City Construction', 'TechAdvantage Software', 'Urban Apparel', 'Global Exports Co.', 'Green Gardens', 'Innovative Tech', 'Solar Solutions'];
    const arValues    = [14534, 10347, 8314, 7100, 5339, 3467, 3412, 2587];
    const donutColors = ['#0A0A0A', '#262626', '#404040', '#525252', '#737373', '#8C8C8C', '#A3A3A3', '#D4D4D4'];

    new Chart(document.getElementById('arBarChart'), {
        type: 'bar',
        data: {
            labels: arCustomers,
            datasets: [{ data: arValues, backgroundColor: '#DC2626', borderRadius: 2, borderSkipped: false }]
        },
        options: {
            indexAxis: 'y',
            responsive: true,
            ...
            scales: {
                x: {
                    grid: { color: '#E5E5E3' },
                    max: 16000,
                    ticks: { font: { family: 'DM Sans', size: 10 }, callback: v => (v / 1000).toFixed(0) + 'K' },
                },
    ...
    new Chart(document.getElementById('arDonutChart'), {
        ...
        data: {
            labels: arCustomers,
            datasets: [{ data: arValues, backgroundColor: donutColors, borderWidth: 1, borderColor: '#fff' }]
        },
        options: {
            responsive: true,
            maintainAspectRatio: false,
    ...
    arCustomers.forEach((name, i) => {
        ...
        legend.innerHTML += `<div class="flex items-center gap-1.5"><span class="inline-block w-2.5 h-2.5 rounded-full flex-shrink-0" style="background:${donutColors[i]}"></span><span class="text-[10px] text-brand-muted">${name}</span></div>`;
    });

    // AP charts
    const apVendors = ['Innovative Tech', 'TechAdvantage Software', 'Coastal Shipping', 'Green Gardens', 'City Construction', 'Urban Apparel', 'Global Exports Co.', 'Solar Solutions'];
    ...
    new Chart(document.getElementById('apBarChart'), {
        ...
        data: {
            labels: apVendors,
            datasets: [{ data: apValues, backgroundColor: '#DC2626', borderRadius: 2, borderSkipped: false }]
        },
        options: {
            indexAxis: 'y',
            responsive: true,
    ...
    new Chart(document.getElementById('apDonutChart'), {
        ...
        data: {
            labels: apVendors,
            datasets: [{ data: apValues, backgroundColor: donutColors, borderWidth: 1, borderColor: '#fff' }]
        },
        options: {
            responsive: true,
            maintainAspectRatio: false,
    ...
    apVendors.forEach((name, i) => {
        apLegend.innerHTML += `<div class="flex items-center gap-1.5"><span class="inline-block w-2.5 h-2.5 rounded-full flex-shrink-0" style="background:${donutColors[i]}"></span><span class="text-[10px] text-brand-muted">${name}</span></div>`;
    });
});
</script>
@endpush
